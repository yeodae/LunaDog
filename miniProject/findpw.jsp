...
<div class="div">
<form name="list" action="findpw_sql.jsp">
	<%@ include file="../jsp_heid_set.jsp" %>
	<div>
		<span><strong>비밀번호 찾기</strong></span>
		<div><input type="text" name="uId" placeholder="아이디"></div>
		<div><input type="text" name="uName" placeholder="보호자이름"></div>
		<div><input type="text" name="phone" placeholder="핸드폰번호"></div>
		<div><input type="text" name="pwhint" placeholder="PW 분실확인용 단어"></div>
